...
$nopieces=$_POST['pices'];
$westage=$_POST['westage'];
$rate=$_POST['rate'];
...
$q="insert into zipper( supplier, nopieces, westage,rate,description)

 values('$supplier','$nopieces','$westage','$rate','$descrip')";

if(mysqli_query($con,$q)){
  
  header('location:zipper.php');
      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Zipper</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center">Zipper Details</h6>
                </div>
...
<div class="form-group">
    <label for="exampleFormControlSelect2">Number of Pieces:</label>
  <input type="number" class="form-control-sm" id="" name="pices">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlSelect2">Westage:</label>

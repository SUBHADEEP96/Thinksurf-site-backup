...
$q="insert into tag( vendorname, quantity, rate,description)

 values('$vendorname','$quantity','$rate','$descrip')";
      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Tag</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center">Tag Details</h6>
                </div>
...
<div class="form-group">
  ...
  <input type="number" class="form-control-sm" id="" name="quantity">
  </div>

 ...
 Piping Rope
            ...
            <div class="col-lg-12">
              ...
              <div class="">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight text-primary text-center"> View Piping Rope Details</h6>
                </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-7 bg-light rounded my-2 py-2">

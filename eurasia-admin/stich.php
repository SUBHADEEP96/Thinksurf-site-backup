    ...
    <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapsefour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded border border-dark">
            <a class="collapse-item font-weight-bold" href="emb.php">Rate Details</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h2 class="h5 mb-4 text-gray-800 text-center">Stiching</h2>
          ...
          <div class="row">
           ...
           <!--   <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center"> View Design Details</h6>
                </div>-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Edit Fabrics Data </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

        <form action="uploadstich.php" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                 <label> Tailor Name </label>
                    <input type="text" name="tailor" id="tailor" class="form-control" placeholder="">
               </div>

                <div class="form-group">
                 <label> Given to stich Date </label>
                 <input type="date" class="form-control" value="<?php echo date('Y-m-d')?>" name="date1" >
                </div>

                <div class="form-group">
                    <label> Given to stich Quantity </label>
                    <input type="text" name="quantity1" id="lname" class="form-control" placeholder="">
                </div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="updatestich1.php" method="POST">

            <div class="modal-body">

                <input name="update_id1" id="update_id1" type="hidden">

                
                <div class="form-group">
                    <label> Recived from stich Date </label>
                    <input type="date" name="date2"  class="form-control" value="<?php echo date('Y-m-d')?>">
                </div>

                <div class="form-group">
                    <label> Recived from stich Quantity </label>
                    <input type="text" name="quantity2" id="contact" class="form-control" placeholder="">
                </div>
        ...
        <table class="table-responsive table table-bordered table-striped table-hover">
          <thead>
            <tr style="font-size: 11px;">
              ...
              <th>Tailor Name</th>
              <th>Given to stich Date</th>
              <th>Given to stich Quantity</th>
              <th>Recived from stich Date</th>
              <th>Recived from stich Quantity</th>
              <th class="">Action</th>
...
<button type="button" class="btn btn-primary">Download</button>
              ...
              <td class="btn-group btn-group-sm"> 
                <button type="button" class="btn btn-primary btn-sm editbtn">Give</button>
               
                <button type="button" class="btn btn-secondary btn-sm editbtn1">Ricv</button>
              </td>

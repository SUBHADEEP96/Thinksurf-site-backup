...
$sql="INSERT INTO fabricpiping (types,color,size,quantity,rate,descirption)

 values('$types','$color','$size','$quantity','$rate','$descrip')";

if(mysqli_query($con,$sql))
{
  
  header('location:fabricpiping.php');
...
<head>
  ...
  <title>Euresia Decor - Piping Fabric</title>
      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center"> Rate </h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center"> Rate Details</h6>
                </div>
...
<br><br>
  <div class="form-group">
    <label for="exampleFormControlSelect2">Add Tailor Name:</label>
  <input type="text" class="form-control-sm" id="" name="type">
  </div>
  
       <div class="form-group">
                <label for="exampleFormControlInput1">Add Embroidery Rtae:</label>
                <input type="text" class="form-control-sm" name="color" id="exampleFormControlInput1" placeholder="">
             </div>
             <!----
        <div class="form-group">
...
<!--
   <div class="form-group">
    <label for="exampleFormControlSelect2">Quantity(Meter):</label>
  <input type="text" class="form-control-sm" id="" name="quantity">
  </div>
       <div class="form-group">
    <label for="exampleFormControlSelect2">Rate(Per Meter):</label>
  <input type="text" class="form-control-sm" id="" name="rate">
  </div>
       <div class="form-group">
    <label for="exampleFormControlTextarea1">Description</label>
    <textarea class="form-control" name="descrip" id="exampleFormControlTextarea1" rows="3" style="color: black;"></textarea>
  </div>
-->
    <div class="form-group">

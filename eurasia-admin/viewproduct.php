      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h4 mb-4 text-gray-800 text-center">View Production</h1>
          <hr>
...
<td>
  <a href="" class="" data-toggle="modal" data-target="#<?= $row['item']?>"><img src="img/<?php echo $row['uploadcad']?>" style="height:40px; width:40px"></a>
</td>
...
<button type="button" class="btn btn-primary">Download</button>
            ...
            <!--  <td><?= $row['threadetails']?>,<?= $row['threadetails1']?></td>-->

...
$q="insert into  thread( nothread, vendorname,  color,description)

 values('$nothread','$vendorname','$color','$descrip')";
...
<head>
  ...
  <title>Euresia Decor - Thread</title>
      ...
      <div id="content">
       ...
       <!--  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Thread</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary text-center">Thread Details</h6>
                </div>
...
<!---form------>
       ...
       <div class="form-group">
                ...
                <label for="exampleFormControlInput1">Thread Number :</label>
                <input type="number" class="form-control-sm" name="threads" id="exampleFormControlInput1" placeholder="">
             </div>
      
  
<div class="form-group">
    <label for="exampleFormControlSelect2">Vendor Name:</label>
  <input type="text" class="form-control-sm" id="" name="vendor">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlSelect2">Color:</label>
  <input type="name" class="form-control-sm" id="" name="color">
  </div>
